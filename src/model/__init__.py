...
def build_modules(params):
    ...
    """
    modules = {}
    modules['encoder'] = TransformerModel(params, params.id2word, is_encoder=True, with_output=False)
    modules['decoder'] = TransformerModel(params, params.id2word, is_encoder=False, with_output=True)
